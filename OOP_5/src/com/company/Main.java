...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Menu cafe = new Menu();
        NonLogic.dva dk = new NonLogic.dva();
        NonLogic.tru kf=new NonLogic.tru();
        
        NonLogic.NonLogic1 fg = null;
        ...
        cafe.skudkaCafe(10);//перевантажити
        cafe.cafe();
        System.out.println("");
        cafe.skudkaCafe();
        System.out.println("");
        ...
        fg = dk;//В головному класі із main()-методом викликати на виконання відповідні методи за допомогою функції динамічної диспетчеризації
        fg.metrazz();
        fg=kf;
        fg.metrazz();
    }
